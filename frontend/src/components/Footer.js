    ...
    <div className={styles.footerWrapper}>
      ...
      <div className={styles.footerSectionTwo}>
        <div className={styles.footerSectionColumns}>
          <a className={styles.footer} href='/tc' target="_blank" rel="noreferrer">Terms & Conditions</a>
          <a className={styles.footer} href='/privacy' target="_blank" rel="noreferrer">Privacy Policy</a>
          <a className={styles.footer} href='/cancellation' target="_blank" rel="noreferrer">Cancellation & Refund</a>
          <a className={styles.footer} href='/shipping' target="_blank" rel="noreferrer">Shipping & Delivery</a>
          <a className={styles.footer} href='/contact' target="_blank" rel="noreferrer">Contact Us</a>
        </div>
      </div>
    </div>
  )
